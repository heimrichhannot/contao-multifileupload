 ...
 */
define('TL_ROOT', dirname(__DIR__) . '/vendor/contao/core');
...
@symlink(TL_ROOT . '/../../../', TL_ROOT . '/system/modules/multifileupload');
@symlink(TL_ROOT . '/../../heimrichhannot/contao-ajax', TL_ROOT . '/system/modules/ajax');
...
//    {
//        return new \Contao\Database\Mysqli\Statement();
//    }
//}
