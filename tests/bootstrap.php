...
$legacyLoader = function ($class) {
    ...
    if (false !== strpos($class, '\\') && 0 !== strncmp($class, 'Contao\\', 7) && !in_array($class, $additional))
    {
        return;
    }
...
// contao 3 inside vendor directory -> use custom contao 3 initialize
if (file_exists(__DIR__ . '/../vendor/contao/core/system/initialize.php') && false === ($contao3 = $include(__DIR__ . '/initialize.php')))
{
    exit(1);
}
